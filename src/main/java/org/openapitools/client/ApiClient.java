...
public class ApiClient {
    ...
    private String basePath = "https://rest.apitemplate.io";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/Version 2.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://rest.apitemplate.io
