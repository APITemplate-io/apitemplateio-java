...
public class ResponseSuccessImageFile {
  ...
  public static final String SERIALIZED_NAME_DOWNLOAD_URL_PNG = "download_url_png";
  @SerializedName(SERIALIZED_NAME_DOWNLOAD_URL_PNG)
  private String downloadUrlPng;
  ...
  public ResponseSuccessImageFile status(String status) {
  ...
  **/
  ...
  public ResponseSuccessImageFile downloadUrl(String downloadUrl) {
  ...
  **/
  ...
  public ResponseSuccessImageFile downloadUrlPng(String downloadUrlPng) {
   ...
   /**
   * Download URL PNG
   * @return downloadUrlPng
  **/
  @javax.annotation.Nullable
  public String getDownloadUrlPng() {
    return downloadUrlPng;
  }


  public void setDownloadUrlPng(String downloadUrlPng) {
    this.downloadUrlPng = downloadUrlPng;
  }


  public ResponseSuccessImageFile templateId(String templateId) {
  ...
  **/
  ...
  public ResponseSuccessImageFile transactionRef(String transactionRef) {
  ...
  **/
  ...
  public ResponseSuccessImageFile postActions(List<ResponseSuccessPDFFilePostActionsInner> postActions) {
    
    this.postActions = postActions;
    return this;
  }

  public ResponseSuccessImageFile addPostActionsItem(ResponseSuccessPDFFilePostActionsInner postActionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResponseSuccessImageFile responseSuccessImageFile = (ResponseSuccessImageFile) o;
    return Objects.equals(this.status, responseSuccessImageFile.status) &&
        Objects.equals(this.downloadUrl, responseSuccessImageFile.downloadUrl) &&
        Objects.equals(this.downloadUrlPng, responseSuccessImageFile.downloadUrlPng) &&
        Objects.equals(this.templateId, responseSuccessImageFile.templateId) &&
        Objects.equals(this.transactionRef, responseSuccessImageFile.transactionRef) &&
        Objects.equals(this.postActions, responseSuccessImageFile.postActions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, downloadUrl, downloadUrlPng, templateId, transactionRef, postActions);
  }
  ...
  public String toString() {
    ...
    sb.append("    downloadUrlPng: ").append(toIndentedString(downloadUrlPng)).append("\n");
  ...
  static {
    ...
    openapiFields.add("download_url_png");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResponseSuccessImageFile
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseSuccessImageFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseSuccessImageFile is not found in the empty JSON string", ResponseSuccessImageFile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseSuccessImageFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseSuccessImageFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("download_url_png") != null && !jsonObj.get("download_url_png").isJsonNull()) && !jsonObj.get("download_url_png").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `download_url_png` to be a primitive type in the JSON string but got `%s`", jsonObj.get("download_url_png").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseSuccessImageFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseSuccessImageFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseSuccessImageFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseSuccessImageFile.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseSuccessImageFile>() {
           @Override
           public void write(JsonWriter out, ResponseSuccessImageFile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseSuccessImageFile read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResponseSuccessImageFile given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResponseSuccessImageFile
  * @throws IOException if the JSON string is invalid with respect to ResponseSuccessImageFile
  */
  public static ResponseSuccessImageFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseSuccessImageFile.class);
  }

 /**
  * Convert an instance of ResponseSuccessImageFile to an JSON string
  *
  * @return JSON string
  */
