...
public class ResponseSuccessDeleteObject {
  ...
  private Object transactionRef = null;

  public ResponseSuccessDeleteObject() {
  }

  public ResponseSuccessDeleteObject status(String status) {
  ...
  **/
  ...
  public ResponseSuccessDeleteObject transactionRef(Object transactionRef) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResponseSuccessDeleteObject responseSuccessDeleteObject = (ResponseSuccessDeleteObject) o;
    return Objects.equals(this.status, responseSuccessDeleteObject.status) &&
        Objects.equals(this.transactionRef, responseSuccessDeleteObject.transactionRef);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, transactionRef);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResponseSuccessDeleteObject
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseSuccessDeleteObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseSuccessDeleteObject is not found in the empty JSON string", ResponseSuccessDeleteObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseSuccessDeleteObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseSuccessDeleteObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseSuccessDeleteObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseSuccessDeleteObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseSuccessDeleteObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseSuccessDeleteObject.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseSuccessDeleteObject>() {
           @Override
           public void write(JsonWriter out, ResponseSuccessDeleteObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseSuccessDeleteObject read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResponseSuccessDeleteObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResponseSuccessDeleteObject
  * @throws IOException if the JSON string is invalid with respect to ResponseSuccessDeleteObject
  */
  public static ResponseSuccessDeleteObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseSuccessDeleteObject.class);
  }

 /**
  * Convert an instance of ResponseSuccessDeleteObject to an JSON string
  *
  * @return JSON string
  */
