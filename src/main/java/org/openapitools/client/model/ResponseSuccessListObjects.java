...
public class ResponseSuccessListObjects {
  ...
  public ResponseSuccessListObjects status(String status) {
  ...
  **/
  ...
  public ResponseSuccessListObjects objects(List<Object> objects) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResponseSuccessListObjects responseSuccessListObjects = (ResponseSuccessListObjects) o;
    return Objects.equals(this.status, responseSuccessListObjects.status) &&
        Objects.equals(this.objects, responseSuccessListObjects.objects);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, objects);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResponseSuccessListObjects
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseSuccessListObjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseSuccessListObjects is not found in the empty JSON string", ResponseSuccessListObjects.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseSuccessListObjects.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseSuccessListObjects` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseSuccessListObjects.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseSuccessListObjects' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseSuccessListObjects> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseSuccessListObjects.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseSuccessListObjects>() {
           @Override
           public void write(JsonWriter out, ResponseSuccessListObjects value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseSuccessListObjects read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResponseSuccessListObjects given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResponseSuccessListObjects
  * @throws IOException if the JSON string is invalid with respect to ResponseSuccessListObjects
  */
  public static ResponseSuccessListObjects fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseSuccessListObjects.class);
  }

 /**
  * Convert an instance of ResponseSuccessListObjects to an JSON string
  *
  * @return JSON string
  */
