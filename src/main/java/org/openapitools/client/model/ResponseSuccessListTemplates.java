...
import org.openapitools.client.model.ResponseSuccessListTemplatesTemplatesInner;
...
public class ResponseSuccessListTemplates {
  ...
  private List<ResponseSuccessListTemplatesTemplatesInner> templates;

  public ResponseSuccessListTemplates() {
  }

  public ResponseSuccessListTemplates status(String status) {
  ...
  **/
  ...
  public ResponseSuccessListTemplates templates(List<ResponseSuccessListTemplatesTemplatesInner> templates) {
    
    this.templates = templates;
    return this;
  }

  public ResponseSuccessListTemplates addTemplatesItem(ResponseSuccessListTemplatesTemplatesInner templatesItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<ResponseSuccessListTemplatesTemplatesInner> getTemplates() {
    return templates;
  }


  public void setTemplates(List<ResponseSuccessListTemplatesTemplatesInner> templates) {
    this.templates = templates;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResponseSuccessListTemplates responseSuccessListTemplates = (ResponseSuccessListTemplates) o;
    return Objects.equals(this.status, responseSuccessListTemplates.status) &&
        Objects.equals(this.templates, responseSuccessListTemplates.templates);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResponseSuccessListTemplates
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseSuccessListTemplates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseSuccessListTemplates is not found in the empty JSON string", ResponseSuccessListTemplates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseSuccessListTemplates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseSuccessListTemplates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("templates") != null && !jsonObj.get("templates").isJsonNull()) {
        ...
        if (jsonArraytemplates != null) {
          ...
          for (int i = 0; i < jsonArraytemplates.size(); i++) {
            ResponseSuccessListTemplatesTemplatesInner.validateJsonElement(jsonArraytemplates.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseSuccessListTemplates.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseSuccessListTemplates' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseSuccessListTemplates> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseSuccessListTemplates.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseSuccessListTemplates>() {
           @Override
           public void write(JsonWriter out, ResponseSuccessListTemplates value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseSuccessListTemplates read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResponseSuccessListTemplates given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResponseSuccessListTemplates
  * @throws IOException if the JSON string is invalid with respect to ResponseSuccessListTemplates
  */
  public static ResponseSuccessListTemplates fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseSuccessListTemplates.class);
  }

 /**
  * Convert an instance of ResponseSuccessListTemplates to an JSON string
  *
  * @return JSON string
  */
