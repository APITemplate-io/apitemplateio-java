...
public class ResponseSuccessQueryImageTemplate {
  ...
  public ResponseSuccessQueryImageTemplate status(String status) {
  ...
  **/
  ...
  public ResponseSuccessQueryImageTemplate width(Integer width) {
  ...
  **/
  ...
  public ResponseSuccessQueryImageTemplate height(Integer height) {
  ...
  **/
  ...
  public ResponseSuccessQueryImageTemplate layers(List<Object> layers) {
    
    this.layers = layers;
    return this;
  }

  public ResponseSuccessQueryImageTemplate addLayersItem(Object layersItem) {
    if (this.layers == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResponseSuccessQueryImageTemplate responseSuccessQueryImageTemplate = (ResponseSuccessQueryImageTemplate) o;
    return Objects.equals(this.status, responseSuccessQueryImageTemplate.status) &&
        Objects.equals(this.width, responseSuccessQueryImageTemplate.width) &&
        Objects.equals(this.height, responseSuccessQueryImageTemplate.height) &&
        Objects.equals(this.layers, responseSuccessQueryImageTemplate.layers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, width, height, layers);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResponseSuccessQueryImageTemplate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseSuccessQueryImageTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseSuccessQueryImageTemplate is not found in the empty JSON string", ResponseSuccessQueryImageTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseSuccessQueryImageTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseSuccessQueryImageTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseSuccessQueryImageTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseSuccessQueryImageTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseSuccessQueryImageTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseSuccessQueryImageTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseSuccessQueryImageTemplate>() {
           @Override
           public void write(JsonWriter out, ResponseSuccessQueryImageTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseSuccessQueryImageTemplate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResponseSuccessQueryImageTemplate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResponseSuccessQueryImageTemplate
  * @throws IOException if the JSON string is invalid with respect to ResponseSuccessQueryImageTemplate
  */
  public static ResponseSuccessQueryImageTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseSuccessQueryImageTemplate.class);
  }

 /**
  * Convert an instance of ResponseSuccessQueryImageTemplate to an JSON string
  *
  * @return JSON string
  */
