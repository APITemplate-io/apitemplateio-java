...
public class ResponseSuccessPDFFilePostActionsInner {
  ...
  public ResponseSuccessPDFFilePostActionsInner() {
  }

  public ResponseSuccessPDFFilePostActionsInner action(String action) {
  ...
  **/
  ...
  public ResponseSuccessPDFFilePostActionsInner name(String name) {
  ...
  **/
  ...
  public ResponseSuccessPDFFilePostActionsInner bucket(String bucket) {
  ...
  **/
  ...
  public ResponseSuccessPDFFilePostActionsInner status(String status) {
  ...
  **/
  ...
  public ResponseSuccessPDFFilePostActionsInner _file(String _file) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResponseSuccessPDFFilePostActionsInner responseSuccessPDFFilePostActionsInner = (ResponseSuccessPDFFilePostActionsInner) o;
    return Objects.equals(this.action, responseSuccessPDFFilePostActionsInner.action) &&
        Objects.equals(this.name, responseSuccessPDFFilePostActionsInner.name) &&
        Objects.equals(this.bucket, responseSuccessPDFFilePostActionsInner.bucket) &&
        Objects.equals(this.status, responseSuccessPDFFilePostActionsInner.status) &&
        Objects.equals(this._file, responseSuccessPDFFilePostActionsInner._file);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, name, bucket, status, _file);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResponseSuccessPDFFilePostActionsInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseSuccessPDFFilePostActionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseSuccessPDFFilePostActionsInner is not found in the empty JSON string", ResponseSuccessPDFFilePostActionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseSuccessPDFFilePostActionsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseSuccessPDFFilePostActionsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseSuccessPDFFilePostActionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseSuccessPDFFilePostActionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseSuccessPDFFilePostActionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseSuccessPDFFilePostActionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseSuccessPDFFilePostActionsInner>() {
           @Override
           public void write(JsonWriter out, ResponseSuccessPDFFilePostActionsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseSuccessPDFFilePostActionsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResponseSuccessPDFFilePostActionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResponseSuccessPDFFilePostActionsInner
  * @throws IOException if the JSON string is invalid with respect to ResponseSuccessPDFFilePostActionsInner
  */
  public static ResponseSuccessPDFFilePostActionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseSuccessPDFFilePostActionsInner.class);
  }

 /**
  * Convert an instance of ResponseSuccessPDFFilePostActionsInner to an JSON string
  *
  * @return JSON string
  */
