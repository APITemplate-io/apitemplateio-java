...
public class ResponseSuccessTemplate {
  ...
  public ResponseSuccessTemplate status(String status) {
  ...
  **/
  ...
  public ResponseSuccessTemplate templateId(String templateId) {
  ...
  **/
  ...
  public ResponseSuccessTemplate body(String body) {
  ...
  **/
  ...
  public ResponseSuccessTemplate css(String css) {
  ...
  **/
  ...
  public ResponseSuccessTemplate settings(String settings) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResponseSuccessTemplate responseSuccessTemplate = (ResponseSuccessTemplate) o;
    return Objects.equals(this.status, responseSuccessTemplate.status) &&
        Objects.equals(this.templateId, responseSuccessTemplate.templateId) &&
        Objects.equals(this.body, responseSuccessTemplate.body) &&
        Objects.equals(this.css, responseSuccessTemplate.css) &&
        Objects.equals(this.settings, responseSuccessTemplate.settings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, templateId, body, css, settings);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResponseSuccessTemplate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseSuccessTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseSuccessTemplate is not found in the empty JSON string", ResponseSuccessTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseSuccessTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseSuccessTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseSuccessTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseSuccessTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseSuccessTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseSuccessTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseSuccessTemplate>() {
           @Override
           public void write(JsonWriter out, ResponseSuccessTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseSuccessTemplate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResponseSuccessTemplate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResponseSuccessTemplate
  * @throws IOException if the JSON string is invalid with respect to ResponseSuccessTemplate
  */
  public static ResponseSuccessTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseSuccessTemplate.class);
  }

 /**
  * Convert an instance of ResponseSuccessTemplate to an JSON string
  *
  * @return JSON string
  */
