...
/**
 * API tests for PdfManipulationApiApi
 */
@Disabled
public class PdfManipulationApiApiTest {

    private final PdfManipulationApiApi api = new PdfManipulationApiApi();
     ...
     */
    @Test
    public void mergePdfsTest() throws ApiException {
        MergePdfsRequest mergePdfsRequest = null;
        String postactionS3Filekey = null;
        String postactionS3Bucket = null;
        String meta = null;
        ResponseSuccessSingleFile response = api.mergePdfs(mergePdfsRequest, postactionS3Filekey, postactionS3Bucket, meta);
